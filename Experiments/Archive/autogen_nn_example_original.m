...
net.performFcn = 'msereg';  % Cross-entropy
...
for i = 1:size(phi,1)
    ...
    input_out = SigmoidNeuron([1; x], l1_weights, norm_c);
    
    % Put the first output into the last layer
    out_1 = LinearNeuron([1; input_out], l2wn1)/length(l2wn1);
    out_2 = LinearNeuron([1; input_out], l2wn2)/length(l2wn2);
    out_3 = LinearNeuron([1; input_out], l2wn3)/length(l2wn3);
